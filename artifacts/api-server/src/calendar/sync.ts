import { db, calendarConnectionsTable, calendarSyncedEventsTable, businessProfilesTable, hasFeature, type Milestone, type CalendarProvider, type CalendarConnection } from "@workspace/db";
