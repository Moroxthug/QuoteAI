...
| 1064 | GET | `/api/jobs/:id/photos/:photoId/file` | session | jobs:view | — | none | — | predicate | — | — | — |
| 1092 | PUT | `/api/jobs/:id/photos/:photoId` | session | jobs:edit | — | zod | — | predicate | — | — | — |
| 1126 | DELETE | `/api/jobs/:id/photos/:photoId` | session | jobs:edit | — | none | — | predicate | — | — | — |
| 1150 | POST | `/api/jobs/:id/photos/share` | session | jobs:edit | — | zod | — | predicate | — | — | — |
| 1213 | POST | `/api/jobs/:id/sms/on-my-way` | session | jobs:edit | — | zod | — | predicate | — | — | — |
...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 127 | GET | `/api/t/:token` | none | — | viewLimiter | none | hasFeature(team_time) | n/a | — | hash-lookup | — |
| 149 | POST | `/api/t/:token/entries` | none | — | writeLimiter | zod | hasFeature(team_time) | n/a | — | hash-lookup | — |
| 199 | POST | `/api/t/:token/clock-in` | none | — | writeLimiter | zod | hasFeature(team_time) | n/a | — | hash-lookup | — |
| 255 | POST | `/api/t/:token/entries/:tid/clock-out` | none | — | writeLimiter | zod | hasFeature(team_time) | n/a | — | hash-lookup | — |
| 309 | DELETE | `/api/t/:token/entries/:tid` | none | — | writeLimiter | none | hasFeature(team_time) | n/a | — | hash-lookup | — |
