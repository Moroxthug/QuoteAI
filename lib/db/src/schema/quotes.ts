...
export const quotesTable = pgTable("quotes", {
  ...
  titoloPreventivoRiga1: text("titolo_preventivo_riga1").default("Project Quote & Itemized Estimate"),
  ...
  ivaPercentuale: numeric("iva_percentuale", { precision: 6, scale: 3 }).notNull().default("0"),
  ...
  note: text("note").notNull().default("Quote valid for 30 days"),
