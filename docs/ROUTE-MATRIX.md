...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 74 | GET | `/api/business-profile` | session | — | — | none | — | n/a | — | — | — |
| 113 | PUT | `/api/business-profile` | session | settings:edit | — | zod | — | n/a | — | — | — |
| 210 | POST | `/api/business-profile/logo` | session | settings:edit | — | none | — | n/a | — | — | — |
| 275 | POST | `/api/business-profile/apikey` | session | settings:edit | — | none | — | n/a | — | — | — |
...
| Line | Method | Path | Auth | Perm | RL | Val | Gate | Scope | Archived | Token | Webhook |
|---|---|---|---|---|---|---|---|---|---|---|---|
| 25 | GET | `/api/cron/tick` | none | — | — | none | — | n/a | — | — | — |
...
| 47 | PUT | `/api/sms/settings` | session | settings:edit | — | zod | — | n/a | — | — | — |
| 72 | POST | `/api/sms/test` | session | settings:edit | — | zod | — | n/a | — | — | — |
| 102 | GET | `/api/sms/messages` | session | settings:view | — | none | — | n/a | — | — | — |
| 116 | POST | `/api/sms/opt-out` | session | leads:edit | — | zod | — | n/a | — | — | — |
| 139 | POST | `/api/sms/webhook` | none | — | webhookLimiter | manual | — | n/a | — | — | x-twilio-signature |
